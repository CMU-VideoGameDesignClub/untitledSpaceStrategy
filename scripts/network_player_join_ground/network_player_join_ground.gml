...
function network_player_join_ground(_username){
	// create a new player object in the room at specified posistion
	
	var _player = instance_create_depth(playerSpawn_x,playerSpawn_y, depth, obj_player_server_ground)
	...
	buffer_write(server_buffer, buffer_u8,NETWORK_SERVER_G.PLAYER_CONNECT);
	...
	repeat(ds_list_size(socket_list))
	{
		...
		if _sock != socket
		{
			...
			buffer_write(server_buffer, buffer_u8,NETWORK_SERVER_G.PLAYER_JOINED);
